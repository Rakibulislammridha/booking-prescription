...
final class UpdateCustomBrandRequest extends FormRequest
{
    public function authorize(): bool
    {
        $brand = $this->route('customBrand');

        return $brand instanceof CustomBrand && ($this->user('web')?->can('update', $brand) ?? false);
    }
