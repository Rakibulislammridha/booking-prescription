...
final class AppointmentWriter
{
    ...
    public function createForSerial(Serial $serial, Patient $patient, SessionInstance $session, BookingChannel $channel, FeeDecision $fee, Actor $actor, array $extra = []): Appointment
    {
