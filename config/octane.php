...
return [
    ...
    */
    ...
    // Singletons that hold request/tenant state (ARCHITECTURE §4.5). Class names are strings: a module's
    // singleton may not exist yet; Octane merely forgets the instance.
    'flush' => [
        Tenancy::class,                  // holds the TenantContext below: both go, so there is exactly one context per operation
        TenantContext::class,
        TenantResolver::class,
        TenantQueuePayload::class,
        ActiveBranch::class,
        AuditRecorder::class,
        'App\\Domain\\Catalog\\Services\\CatalogWriteContext',
    ],
