...
// Serial engine JSON endpoints for the staff session (engineer S). The reception board (R) and the session-day page
// call these; the same controllers serve routes/api/serials.php for Sanctum clients. Parameters bind by public_id.
