...
// recharts is ~97 KB gzip; the tiles and the top-clinics table are what the screen is for. The chart arrives
// after first paint and not at all for a metric nobody has recorded (Components/Charts/LazyChart.tsx).
      ...
      <Stack spacing={2}>
        ...
        <Card variant="outlined">
          <CardContent>
            ...
            <LazyChart height={260} empty={series.length === 0}>
