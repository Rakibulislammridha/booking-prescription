...
const ITEMS: NavItem[] = [
  ...
  { key: 'billing', routeName: 'super.billing.index', pattern: 'super.billing.*', label: 'super.nav.billing' },
  { key: 'usage', routeName: 'super.usage.index', pattern: 'super.usage.*', label: 'super.nav.usage' },
  { key: 'catalog', routeName: 'super.catalog.index', pattern: 'super.catalog.index', label: 'super.nav.catalog' },
  { key: 'imports', routeName: 'super.catalog.imports.index', pattern: 'super.catalog.imports.*', label: 'super.nav.imports' },
  ...
  { key: 'admins', routeName: 'super.admins.index', pattern: 'super.admins.*', label: 'super.nav.admins' },
  { key: 'notifications', routeName: 'super.notifications.index', pattern: 'super.notifications.*', label: 'super.nav.notifications' },
